...
output_path = base_path + '\\Output\\SingleParameterRegression\\Prediction\\Interpolation\\GPT35\\'
...
# output_path = base_path + '\\Output\\SingleParameterRegression\\Prediction\\Extrapolation\\GPT35\\'
...
for i in range(iterations): 
    for temperature in temperatures: 
        ...
        for file in data_file_list:
            ...
            filename = output_path+'Responses_SingleParameterData_ChatGPT35_Prediction_iter_'+str(i+1)+'_temp_'+str(temperature)+'.xlsx'
