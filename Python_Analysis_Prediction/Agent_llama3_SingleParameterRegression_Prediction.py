...
output_path = base_path + '/Output/SingleParameterRegression/Prediction/Interpolation/llama/'
...
# output_path = base_path + '/Output/SingleParameterRegression/Prediction/Extrapolation/llama/'
...
for i in range(iterations): 
    for temperature in temperatures: 
        ...
        for file in data_file_list:
            ...
            filename = output_path+'Responses_SingleParameterData_llama3_Prediction_iter_'+str(i+1)+'_temp_'+str(temperature)+'.xlsx'
